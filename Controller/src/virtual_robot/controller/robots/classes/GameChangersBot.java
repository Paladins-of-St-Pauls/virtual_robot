...
public class GameChangersBot extends VirtualBot {
    ...
    public synchronized void updateStateAndSensors(double millis) {
        ...
        double sceneX = halfFieldWidth + x;
        double sceneY = -(y - halfFieldWidth);

        sensorRotate.setAngle(-headingRadians * 180.0 / Math.PI);
        sensorRotate.setPivotX(sceneX);
        sensorRotate.setPivotY(sceneY);
        javafx.geometry.Point2D leftScenePoint = sensorRotate.transform(sceneX - halfBotWidth + leftSensorCircle.getCenterX(), sceneY - halfBotWidth + leftSensorCircle.getCenterY());
        javafx.geometry.Point2D rightScenePoint = sensorRotate.transform(sceneX - halfBotWidth + rightSensorCircle.getCenterX() + 5.0, sceneY - halfBotWidth + rightSensorCircle.getCenterY());


        leftColorSensor.updateColor(leftScenePoint.getX() - halfFieldWidth, -(leftScenePoint.getY() - halfFieldWidth));
        ...
        rightColorSensor.updateColor(rightScenePoint.getX() - halfFieldWidth, -(rightScenePoint.getY() - halfFieldWidth));
