...
public class GamePadSteerSoftDrive extends PaladinsComponent {
    ...
    public GamePadSteerSoftDrive(PaladinsOpMode opMode, Gamepad gamepad, DcMotor leftMotor, DcMotor rightMotor, double maxAcceleration) {
        super(opMode);
